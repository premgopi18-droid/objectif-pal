 ...
 * testée — le script `maintenance-purge.mjs` ne fait que l'appliquer.
 *
...
/**
 * @param {{ path: string; createdAt: string | null | undefined; referenced: Set<string>; cutoffMs: number }} input
 * @returns {boolean}
 */
export function isOrphan({ path, createdAt, referenced, cutoffMs }) {
