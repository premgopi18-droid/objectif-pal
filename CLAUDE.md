...
- Dump source : `C:\Users\premg\Downloads\current\2026-07-01.sql` (3,76 Go, régénéré tous les 15 jours sur
  ...
  une fois par mois** (`npm run gcd:load`) : entre deux, l'**API REST publique de comics.org** relit chaque
  nuit les séries reliées au référentiel (`series:gcd-live`, #308) — fin, dernier numéro, fascicules
  nouveaux avec ISBN et code-barres.
