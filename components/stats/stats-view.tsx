...
import { SeriesSummarySection } from "@/components/stats/series-summary";
...
type StatsViewProps = {
  ...
  /** La moisson du suivi de séries (§4.17, lot C) — dérivée côté serveur ; absente ou nulle, la section explique. */
  seriesSummary?: { summary: SeriesSummary; seriesCount: number } | null;
};

export function StatsView({ records, readingEvents, seriesSummary = null }: StatsViewProps) {
  ...
  return (
    <div className="mt-3 flex flex-col gap-6">
      ...
      {/* Mes séries (§4.17, lot C) : la moisson du suivi de séries — tuiles,
          dette de série, à lire ensuite. Remplace « Séries en cours » et son
          catalogue GCD (§4.5, retirés par §4.17-5). */}
      <section>
